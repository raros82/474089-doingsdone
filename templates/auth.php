    ...
    <main class="content__main">
        ...
        <form class="form" action="auth.php" method="post" enctype="multipart/form-data">
            <div class="form__row">
                ...
                <input class="form__input <?php if (isset($errors['email'])): ?>form__input--error<?php endif; ?>" type="text" name="email" id="email" value="<?php if (isset($form['email'])){echo($form['email']);}?>" placeholder="Введите e-mail">
